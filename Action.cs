...
namespace Script
{
    ...
    public partial class VuserClass
    {
        ...
        public int Action()
        {
            ...
            NavDataSet af_nds_orig = nofa_1_mf.DataSet;

            //извлекаем из структуры NAV отражением и проверяем что внурри до перезаписи
            var af_nds_DS_orig = af_nds_orig.GetType().GetProperty("DataSet", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public);
            var af_nds_DS_orig_val = af_nds_DS_orig.GetValue(af_nds_orig);
            byte[] af_nds_D_orig_byte = (byte[])af_nds_DS_orig_val.GetType().GetProperty("Data").GetValue(af_nds_DS_orig_val);

            string af_nds_orig_str = System.Text.Encoding.UTF8.GetString((byte[])af_nds_D_orig_byte);

            //************************************
            //       DATA FIELD CORRELATION
            //записываем в структуру NAV отражением
            string InvoicePosting_str = "";
            byte[] InvoicePosting_byte = Convert.FromBase64String(InvoicePosting_str);

            string af_invoice_orig_str = System.Text.Encoding.UTF8.GetString((byte[])InvoicePosting_byte);


            for (int i = 0; i < InvoicePosting_byte.Length; i++)
            {
                if (InvoicePosting_byte.Skip(i).Take(poav_pattern.Length).SequenceEqual(poav_pattern))
                {
                    correlate_data_field(i + 8, InvoicePosting_byte, POAV_NUMBER);
                }

                if (InvoicePosting_byte.Skip(i).Take(poav_pattern2.Length).SequenceEqual(poav_pattern2))
                {
                    correlate_data_field_id2(i + 21, InvoicePosting_byte, POAV_NUMBER);
                }

                if (InvoicePosting_byte.Skip(i).Take(poav_pattern3.Length).SequenceEqual(poav_pattern3))
                {
                    correlate_data_field_id2(i + 21, InvoicePosting_byte, POAV_NUMBER);
                }
            }
            ...
            NavDataSet af_nds_corr = new NavDataSet { DataSetName = "Purchase Header" };

            var af_nds_DS_corr = af_nds_corr.GetType().GetProperty("DataSet", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public).GetValue(af_nds_corr);
            af_nds_DS_corr.GetType().GetProperty("Data", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public).SetValue(af_nds_DS_corr, InvoicePosting_byte);
            af_nds_corr.GetType().GetProperty("DataSet", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public).SetValue(af_nds_corr, af_nds_DS_corr);

            af_nds_orig = af_nds_corr;

            //извлекаем из структуры NAV отражением и проверяем что записалось
            var af_nds_DS_corr_2 = af_nds_orig.GetType().GetProperty("DataSet", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public);
            var af_nds_DS_corr_val = af_nds_DS_corr_2.GetValue(af_nds_orig);
            byte[] af_nds_D_corr_byte = (byte[])af_nds_DS_corr_val.GetType().GetProperty("Data").GetValue(af_nds_DS_corr_val);

            string af_nds_corr_str = System.Text.Encoding.UTF8.GetString((byte[])af_nds_D_corr_byte);
            //************************************
            ...
            service.ActionField(state: ref mf_1_s_c_7, recDataSet: af_nds_orig, 52, 52);
